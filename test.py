...
question_prompts=[
    ...
    "Переведите дробное десятичное число 946,3 в восьмеричной сс до двух знаков после запятой.\n(a) 1762,33\n(b) 1672,33\n(c) 1662,23\n(d) 1672,23\n\n",
    "Переведите дробное восьмеричное число 365,1 в десятичную сс до трех знаков после запятой.\n(a) 245,125\n(b) 246.125\n(c) 246.126\n(d) 255,126\n\n",
...
def run_test(questions) :
    ...
    for question in questions:
        ...
        if otvet==question.otvet:
            k += 1
    print("У вас"+str(k) + " ответов из" + str(len(questions)) + "верны")
run_test(questions)
